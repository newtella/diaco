...
<head>
	<meta charset="utf-8" />
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('public/img/logodiaco.png')}}">
	<link rel="icon" type="image/png" href="{{asset('public/img/logodiaco.png')}}">
	...
	<nav class="navbar navbar-default navbar-absolute">
		<div class="container">
           ...
           <div class="logo-container">
                <div class="logo">
                    <img src="{{asset('public/img/logodiaco.png')}}" width="150px" height="50px" alt="Creative Tim Logo" class="img-rounded img-responsive img-raised">
                </div>
            </div>
