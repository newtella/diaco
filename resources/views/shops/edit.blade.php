        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                <div class="card card-signup">
                    <form class="form" method="POST" action="{{ route('shops.update',$shop->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="content">
                            ...
                            <div class="input-group">
										...
										<input type="text" class="form-control" placeholder="Nombre..." name="name" value="{{ $shop->name }}" required autocomplete="name" autofocus>
							</div>
